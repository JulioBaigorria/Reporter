...
class HomeListView(ListView):
    ...
    def get_context_data(self):
        ...
        sales_df = pd.DataFrame(self.queryset.values())
    ...
    def get_queryset(self):
        ...
        # result_type = self.request.POST.get('result_type')
        

        # if date_from:
        #     queryset = Sale.objects.filter(
        #         Q(created__icontains=date_from) | Q(created__icontains=date_to)
        #     )
        #     print(date_to)
        #     print(date_from)
        #     return queryset
